...
const navigation = [
  ...
  { name: "In The Community", href: "#timeline" },
];
              ...
              >
                <div className="flex items-center flex-grow flex-shrink-0 lg:flex-grow-0">
                  <div className="flex items-center justify-between w-full md:w-auto">
                    <a href="#">
                      <span className="sr-only">John Weland for Jackson</span>
                      {/* <img
                                                alt="Workflow"
          ...
          <div className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline">John Weland</span>{" "}
                <span className="block text-emerald-600 xl:inline">
                  For Jackson City Council
                </span>
              </h1>
              <p className="mt-3 text-base font-bold italic text-gray-500 sm:mt-5 sm:text-xl sm:max-w-xl sm:mx-auto md:mt-5 md:text-2xl lg:mx-0">
